package co.doctor404.tb.HeartRateCheck;
...
public class MainHeartRateActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = findViewById(R.id.toolbar_mainHeartRateCheck);
        ...
        if (intentThatStartedThisActivity.hasExtra("age")) {
            age = Integer.parseInt(intentThatStartedThisActivity.getStringExtra("age"));
        }
//        rhr = Integer.parseInt(intentThatStartedThisActivity.getStringExtra("restingHeartRate"));
    ...
    private static Camera.PreviewCallback previewCallback = new Camera.PreviewCallback() {
        ...
        public void onPreviewFrame(byte[] data, Camera cam) {
            ...
            if (totalTimeInSecs >= 10) {
                ...
                resultString = "timeStamp:" + timestamp + ",heartBeat:" + heartRate;
    ...
    public void finish() {
        ...
        data.putExtra("resultString", getResultString());
