...
import co.doctor404.tb.HeartRateCheck.Home;
import co.doctor404.tb.R;
import co.doctor404.tb.tb_screening.ScreeningAudioQAFragment;
        ...
        switch (v.getId()) {
            case R.id.mconsult:
                Intent browserIntent1 = new Intent(Intent.ACTION_VIEW,
                        Uri.parse("https://api.whatsapp.com/send?phone=918763041844&text=&source=&data="));
                startActivity(browserIntent1);
                break;
            case R.id.physician_consultation:
                Intent browserIntent2 = new Intent(Intent.ACTION_VIEW,
                        Uri.parse("https://api.whatsapp.com/send?phone=919658600961&text=&source=&data="));
