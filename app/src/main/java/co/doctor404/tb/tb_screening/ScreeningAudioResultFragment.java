package co.doctor404.tb.tb_screening;
...
import co.doctor404.tb.dashboard.MainActivity;
import co.doctor404.tb.R;
import co.doctor404.tb.managers.Constants;
import co.doctor404.tb.managers.StaticSaver;
    ...
    private void updateDoc() {
        try {
            ...
            writer.append("Symptoms: " + symptomsData.getText()
                    ...
                    + ";\nSpectrum Analysis: " + "sensed dry cough; Download whole spectrum at https://doctor404.co/spectrum=23xdsj");
            writer.flush();
            writer.close();
